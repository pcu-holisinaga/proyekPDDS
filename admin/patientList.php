                                        ...
                                        <tbody>
                                            <?php if (mysqli_num_rows($result) > 0) { ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $no ?></td>
                                                        <td>PAT-<?php echo $data["id"]; ?></td>
                                                        <td><?php echo $data["name"]; ?></td>
                                                        <td><?php echo $data["username"]; ?></td>
                                                        <td><?php echo $data["dob"]; ?></td>
                                                        <td>
                                                            <input type="submit" name="editPat" class="btn btn-success" value="Edit">
                                                            <input type="submit" name="delPat" class="btn btn-danger" value="Delete">
                                                        </td>
                                                    </tr>
                                                <?php $no++;
                                                } ?>
