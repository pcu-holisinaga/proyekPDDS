            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Doctor Section</h1>
                    </div>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <form class="form-horizontal" method="POST">
                                                    ...
                                                    <div class="form-group form-group-lg">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="input-group">
                                                                <input class="form-control" id="name" name="name" type="text" placeholder="Doctor's Fullname" required />
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="form-group form-group-lg">
                                                        <label class="control-label col-sm-2 requiredField" for="spesialisasi">
                                                            Spesialisasi
                                                            <span class="asteriskField">
                                                                *
                                                            </span>
                                                    ...
                                                    <div class="form-group form-group-lg">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="input-group clockpicker" data-align="top" data-autoclose="true">
                                                                <input class="form-control" id="username" name="username" type="text" placeholder="Doctor's Username" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group form-group-lg">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="input-group clockpicker" data-align="top" data-autoclose="true">
                                                                <input class="form-control" id="email" name="email" type="email" placeholder="Doctor's Email" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-10 col-sm-offset-2">
                                                            <button class="btn btn-primary " name="addDoctor" type="submit">
                                                                Add Doctor
                                                            </button>
                                                        </div>
                                                    </div>
